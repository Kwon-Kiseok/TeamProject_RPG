...
namespace PolyPerfect
{
    ...
    public class MakeCharacters : MonoBehaviour
    {
        ...
        public class CustomSetUp
        {
            ...
            public PolyPerfect.AIStats stats;
        }
                    ...
                    if (meshID == i)
                    {
                        ...
                        for (int setUpIndex = 0; setUpIndex < customSetUp.Length; setUpIndex++)
                        {
                            if (newRig.name.Contains(customSetUp[setUpIndex].meshName))
                            {
                                ...
                                newRig.GetComponent<PolyPerfect.Common_WanderScript>().species = customSetUp[setUpIndex].wanderSpeciesName;
                                newRig.GetComponent<PolyPerfect.Common_WanderScript>().stats = customSetUp[setUpIndex].stats;
                            }
                        }
                    }
                }
