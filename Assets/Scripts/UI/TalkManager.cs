...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(2000, new string[] { "감사합니다!" });
        talkData.Add(3000, new string[] { "조심해!" });

        // 늙은 고블린 퀘스트
        talkData.Add(10 + 1000, new string[] { "어서오시게, 용사여..", "강해보이는군.", "내 부탁 하나 들어주겠는가?" });
        talkData.Add(11 + 1000, new string[] { "고맙다네. 도움 받고 염치없지만..", "혹시 괜찮다면 마을사람들을 구출해줄 수 있겠나?"});

        // 마을 남자 퀘스트
        talkData.Add(20 + 1000, new string[] { "가장 가까운 마을 사람은 바로 이 앞 동굴에 있네." });
        talkData.Add(21 + 2000, new string[] { "감사합니다!", "정말 감사합니다!", "하지만 아직 구출이 안 된 마을 사람이 있습니다.", "부탁드립니다." });

        // 마을 여자 퀘스트
        talkData.Add(30 + 3000, new string[] { "너도 마왕을 잡으러 온 거야?", "특별히 너한테 먼저 양보해줄게" });
    }
